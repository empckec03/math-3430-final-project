...
rain_only
```
**This is a bar graph of the average points scored per race for each driver, with the bars colored by constructor. It reveals that Max Verstappen has the highest average number of points scored each race and Sergio Perez had the second highest amount. The plot reveals Verstappen and then Perez are the most consistent drivers and Red Bull Racing is the most consistent constructor when looking at the season as a whole. The least consistent drivers were Nyck De Vries (averages 0 pts per race) and then Logan Sargeant. The least consistent constructors appear to be AlphaTauri, Haas, and Alfa Romeo.**
```{r}
results %>%

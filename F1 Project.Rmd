...
**Below is a group of bar plots, broken up by constructor. Each graph is color coded according to the driver that scored the points shown for their constructor.**
```{r}
results %>%
...
```
**These graphs show many things. Many teams were very spread out with how many points they scored per race, such as Red Bull or Ferrari. Other teams were highly concentrated in the low point range, such as Williams or Alfa Romeo. There were no teams that were highly concentrated in the high point range. One Red Bull driver (Max Verstappen) consistently outscored the other Red Bull driver (Sergio Perez).**
